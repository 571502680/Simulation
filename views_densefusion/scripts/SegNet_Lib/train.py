...
parser.add_argument('--dataset_root', default='../datasets/ycb/YCB_Video_Dataset/data', help="dataset root dir (''YCB_Video Dataset'')")
    ...
    for epoch in range(1, opt.n_epochs):
        ...
        for i, data in enumerate(dataloader, 0):
            ...
            try:
                ...
                print("exits label bigger than 60")
